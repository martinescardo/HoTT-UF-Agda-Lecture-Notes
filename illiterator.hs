{-
   ...
   It keeps only what is within code environments, removing lines which
   consist of comments without code. It is a unix pipe with no
   arguments. There are no command-line options.
